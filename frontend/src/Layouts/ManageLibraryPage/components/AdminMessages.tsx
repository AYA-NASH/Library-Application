...
export const AdminMessages = ()=>{
    ...
    async function submitResponseToQuestion(id: number, response: string){
        ...
        if(token && id !== null && response !== null){
            const messageAdminRequestAdmin: AdminMessageRequest =  new AdminMessageRequest(id, response);
            const requestOptions = {
                method: 'PUT',
                headers: {
                    Authorization: `Bearer ${token}`,
            ...
            const messageAdminRequestAdminResponse = await fetch(url, requestOptions);
