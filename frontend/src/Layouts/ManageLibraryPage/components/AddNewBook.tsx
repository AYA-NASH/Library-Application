...
export const AddNewBook = ()=>{
    ...
    async function submitNewBook(){
        ...
        if(user && title !== '' && author != '' && category !== 'Category'
            && decscription !== '' && copies >= 0
        ){
            const book: AddBookRequest = new AddBookRequest(title, author, decscription, copies, category);
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-12 mb-3">
                                ...
                                <textarea className="form-control" id="exampleFormControlTextarea1" rows={3}
                                    onChange={e=> setDescription(e.target.value)} value={decscription}
                                >
                                </textarea>
                            </div>
